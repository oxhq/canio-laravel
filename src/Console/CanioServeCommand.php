...
final class CanioServeCommand extends Command
{
    ...
    protected $description = 'Start the local Stagehand runtime daemon';

    public function handle(StagehandBinaryResolver $resolver): int
    {
        ...
        $port = (string) ($this->option('port') ?: ($runtime['port'] ?? 9514));
